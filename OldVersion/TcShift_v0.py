# -*- coding: utf-8 -*-
"""
Created on Tue Feb 22 20:05:47 2022

@author: jungu

This is an old version, didn't simplify the expression to tanh(x),
which get rid of the singularities in the integrand, and make the code faster.
"""
...
# integrand in Sigma_Delta(there are singularities at e and -e)
def funcd(x, t, n, e):
    return x*(nf(x-e,t)/(x-e)-nf(x+e,t)/(x+e))/(((2*n+1)*np.pi*t)**2+x*x)
...
def funcw(x, t, n, e):
    return (nf(x-e,t)-nf(x+e,t))/(((2*n+1)*np.pi*t)**2+x*x)
